...
public interface StockSummaryService {
     ...
     * Returns quotation-level blocked stock details
     */
    java.util.List<java.util.Map<String, Object>> getBlockedDetails(String itemDescription);

    /**
     * Get SO allotted quantity details for a given item description
     * Returns sales-order-level allocation details
     */
    java.util.List<java.util.Map<String, Object>> getSoAllottedDetails(String itemDescription);
}
