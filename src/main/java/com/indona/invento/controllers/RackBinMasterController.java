...
public class RackBinMasterController {
    ...
    public ResponseEntity<?> getEligibleBins(
            ...
            @RequestParam(required = false, defaultValue = "0") Double additionalAllocatedWeight) {
        try {
            Map<String, Object> result = service.findBestEligibleBin(itemCategory, bundleNetWeight, store, unitName, additionalAllocatedWeight);
